...
<div id="main" class="alt">
    ...
    <section id="one">
        <div class="inner">
            ...
            <!-- Content -->
            <div id="content" style="color:#212529;">当社が提供するサービスのご利用に置ける利用規約と、プライバシーポリシーです。</div>
            <br>
            <div class="row">
                <div class="tabs">
